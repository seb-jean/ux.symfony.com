 ...
 *     controllers_path?: scalar|Param|null, // The path to the directory where Svelte controller components are stored - relevant only when using symfony/asset-mapper. // Default: "%kernel.project_dir%/assets/svelte/controllers"
 *     name_glob?: list<scalar|Param|null>,
 * }
